...
const TRANSLATIONS = {
  ...
  'kat.business.item1': { de:'Firmenschilder', en:'Firmenschilder', fr:'Firmenschilder', es:'Firmenschilder', it:'Firmenschilder' },
  'kat.business.item1.long': { de:'Professionelle Schilder aus Acryl, Holz oder mit Metallgravur. Lasergeschnitten und graviert — für Empfang, Büro oder Messestand.', en:'Professionelle Schilder aus Acryl, Holz oder mit Metallgravur. Lasergeschnitten und graviert — für Empfang, Büro oder Messestand.', fr:'Professionelle Schilder aus Acryl, Holz oder mit Metallgravur. Lasergeschnitten und graviert — für Empfang, Büro oder Messestand.', es:'Professionelle Schilder aus Acryl, Holz oder mit Metallgravur. Lasergeschnitten und graviert — für Empfang, Büro oder Messestand.', it:'Professionelle Schilder aus Acryl, Holz oder mit Metallgravur. Lasergeschnitten und graviert — für Empfang, Büro oder Messestand.' },
  'kat.business.item1.spec1': { de:'Acryl, Holz, Metall', en:'Acryl, Holz, Metall', fr:'Acryl, Holz, Metall', es:'Acryl, Holz, Metall', it:'Acryl, Holz, Metall' },
  'kat.business.item1.spec2': { de:'Bis 400×400mm', en:'Bis 400×400mm', fr:'Bis 400×400mm', es:'Bis 400×400mm', it:'Bis 400×400mm' },
  'kat.business.item1.spec3': { de:'Preis: ab 25 €', en:'Preis: ab 25 €', fr:'Preis: ab 25 €', es:'Preis: ab 25 €', it:'Preis: ab 25 €' },
  'kat.business.item2': { de:'Produkt-Prototypen', en:'Produkt-Prototypen', fr:'Produkt-Prototypen', es:'Produkt-Prototypen', it:'Produkt-Prototypen' },
  'kat.business.item2.long': { de:'Vom digitalen Konzept zum anfassbaren Modell. Schnelle Iterationen für Präsentationen, Tests und Investoren-Pitches.', en:'Vom digitalen Konzept zum anfassbaren Modell. Schnelle Iterationen für Präsentationen, Tests und Investoren-Pitches.', fr:'Vom digitalen Konzept zum anfassbaren Modell. Schnelle Iterationen für Präsentationen, Tests und Investoren-Pitches.', es:'Vom digitalen Konzept zum anfassbaren Modell. Schnelle Iterationen für Präsentationen, Tests und Investoren-Pitches.', it:'Vom digitalen Konzept zum anfassbaren Modell. Schnelle Iterationen für Präsentationen, Tests und Investoren-Pitches.' },
  'kat.business.item2.spec1': { de:'FDM, Resin oder Laser', en:'FDM, Resin oder Laser', fr:'FDM, Resin oder Laser', es:'FDM, Resin oder Laser', it:'FDM, Resin oder Laser' },
  'kat.business.item2.spec2': { de:'Turnaround: 24–72h', en:'Turnaround: 24–72h', fr:'Turnaround: 24–72h', es:'Turnaround: 24–72h', it:'Turnaround: 24–72h' },
  'kat.business.item2.spec3': { de:'Preis: ab 15 €', en:'Preis: ab 15 €', fr:'Preis: ab 15 €', es:'Preis: ab 15 €', it:'Preis: ab 15 €' },
  'kat.business.item3': { de:'Kleinserien', en:'Kleinserien', fr:'Kleinserien', es:'Kleinserien', it:'Kleinserien' },
  'kat.business.item3.long': { de:'Serienproduktion bis 50 Stück — Verpackungen, Displays, Werbemittel, Messe-Giveaways.', en:'Serienproduktion bis 50 Stück — Verpackungen, Displays, Werbemittel, Messe-Giveaways.', fr:'Serienproduktion bis 50 Stück — Verpackungen, Displays, Werbemittel, Messe-Giveaways.', es:'Serienproduktion bis 50 Stück — Verpackungen, Displays, Werbemittel, Messe-Giveaways.', it:'Serienproduktion bis 50 Stück — Verpackungen, Displays, Werbemittel, Messe-Giveaways.' },
  'kat.business.item3.spec1': { de:'Konsistente Qualität', en:'Konsistente Qualität', fr:'Konsistente Qualität', es:'Konsistente Qualität', it:'Konsistente Qualität' },
  'kat.business.item3.spec2': { de:'Mengenrabatt möglich', en:'Mengenrabatt möglich', fr:'Mengenrabatt möglich', es:'Mengenrabatt möglich', it:'Mengenrabatt möglich' },
  'kat.business.item3.spec3': { de:'Preis: auf Anfrage', en:'Preis: auf Anfrage', fr:'Preis: auf Anfrage', es:'Preis: auf Anfrage', it:'Preis: auf Anfrage' },
  'kat.business.item4': { de:'Messe- & Event-Material', en:'Messe- & Event-Material', fr:'Messe- & Event-Material', es:'Messe- & Event-Material', it:'Messe- & Event-Material' },
  'kat.business.item4.long': { de:'Lasergeschnittene Displays, 3D-gedruckte Produkthalter, gravierte Namensschilder für Konferenzen.', en:'Lasergeschnittene Displays, 3D-gedruckte Produkthalter, gravierte Namensschilder für Konferenzen.', fr:'Lasergeschnittene Displays, 3D-gedruckte Produkthalter, gravierte Namensschilder für Konferenzen.', es:'Lasergeschnittene Displays, 3D-gedruckte Produkthalter, gravierte Namensschilder für Konferenzen.', it:'Lasergeschnittene Displays, 3D-gedruckte Produkthalter, gravierte Namensschilder für Konferenzen.' },
  'kat.business.item4.spec1': { de:'Schnelle Fertigung', en:'Schnelle Fertigung', fr:'Schnelle Fertigung', es:'Schnelle Fertigung', it:'Schnelle Fertigung' },
  'kat.business.item4.spec2': { de:'Auch kurzfristig', en:'Auch kurzfristig', fr:'Auch kurzfristig', es:'Auch kurzfristig', it:'Auch kurzfristig' },
  'kat.business.item4.spec3': { de:'Preis: ab 10 €', en:'Preis: ab 10 €', fr:'Preis: ab 10 €', es:'Preis: ab 10 €', it:'Preis: ab 10 €' },
  'kat.business.item5': { de:'QR-Code Schilder', en:'QR-Code Schilder', fr:'QR-Code Schilder', es:'QR-Code Schilder', it:'QR-Code Schilder' },
  'kat.business.item5.long': { de:'Dauerhaft gravierte QR-Codes auf Holz, Acryl oder Metall — für Menüs, Bewertungen, Visitenkarten.', en:'Dauerhaft gravierte QR-Codes auf Holz, Acryl oder Metall — für Menüs, Bewertungen, Visitenkarten.', fr:'Dauerhaft gravierte QR-Codes auf Holz, Acryl oder Metall — für Menüs, Bewertungen, Visitenkarten.', es:'Dauerhaft gravierte QR-Codes auf Holz, Acryl oder Metall — für Menüs, Bewertungen, Visitenkarten.', it:'Dauerhaft gravierte QR-Codes auf Holz, Acryl oder Metall — für Menüs, Bewertungen, Visitenkarten.' },
  'kat.business.item5.spec1': { de:'Holz, Acryl, Metall', en:'Holz, Acryl, Metall', fr:'Holz, Acryl, Metall', es:'Holz, Acryl, Metall', it:'Holz, Acryl, Metall' },
  'kat.business.item5.spec2': { de:'Wetterfest möglich', en:'Wetterfest möglich', fr:'Wetterfest möglich', es:'Wetterfest möglich', it:'Wetterfest möglich' },
  'kat.business.item5.spec3': { de:'Preis: ab 8 €', en:'Preis: ab 8 €', fr:'Preis: ab 8 €', es:'Preis: ab 8 €', it:'Preis: ab 8 €' },
  'kat.business.item6': { de:'Branding-Pakete', en:'Branding-Pakete', fr:'Branding-Pakete', es:'Branding-Pakete', it:'Branding-Pakete' },
  'kat.business.item6.long': { de:'Komplettpaket: Firmenschild + Visitenkarten-Halter + Schlüsselanhänger + Muster. Alles im Corporate Design.', en:'Komplettpaket: Firmenschild + Visitenkarten-Halter + Schlüsselanhänger + Muster. Alles im Corporate Design.', fr:'Komplettpaket: Firmenschild + Visitenkarten-Halter + Schlüsselanhänger + Muster. Alles im Corporate Design.', es:'Komplettpaket: Firmenschild + Visitenkarten-Halter + Schlüsselanhänger + Muster. Alles im Corporate Design.', it:'Komplettpaket: Firmenschild + Visitenkarten-Halter + Schlüsselanhänger + Muster. Alles im Corporate Design.' },
  'kat.business.item6.spec1': { de:'3D-Druck + Laser', en:'3D-Druck + Laser', fr:'3D-Druck + Laser', es:'3D-Druck + Laser', it:'3D-Druck + Laser' },
  'kat.business.item6.spec2': { de:'Individuelle Beratung', en:'Individuelle Beratung', fr:'Individuelle Beratung', es:'Individuelle Beratung', it:'Individuelle Beratung' },
  'kat.business.item6.spec3': { de:'Preis: ab 50 €', en:'Preis: ab 50 €', fr:'Preis: ab 50 €', es:'Preis: ab 50 €', it:'Preis: ab 50 €' },
  'kat.deko.item1.long': { de:'Türschilder, Namensschilder, Sprüche und Logos — lasergraviert auf echtem Holz. Perfekt als Geschenk.', en:'Türschilder, Namensschilder, Sprüche und Logos — lasergraviert auf echtem Holz. Perfekt als Geschenk.', fr:'Türschilder, Namensschilder, Sprüche und Logos — lasergraviert auf echtem Holz. Perfekt als Geschenk.', es:'Türschilder, Namensschilder, Sprüche und Logos — lasergraviert auf echtem Holz. Perfekt als Geschenk.', it:'Türschilder, Namensschilder, Sprüche und Logos — lasergraviert auf echtem Holz. Perfekt als Geschenk.' },
  'kat.deko.item1.spec1': { de:'Material: Echtholz, Bambus', en:'Material: Echtholz, Bambus', fr:'Material: Echtholz, Bambus', es:'Material: Echtholz, Bambus', it:'Material: Echtholz, Bambus' },
  'kat.deko.item1.spec2': { de:'Gravur: 0.1mm Standard', en:'Gravur: 0.1mm Standard', fr:'Gravur: 0.1mm Standard', es:'Gravur: 0.1mm Standard', it:'Gravur: 0.1mm Standard' },
  'kat.deko.item1.spec3': { de:'Preis: ab 12 €', en:'Preis: ab 12 €', fr:'Preis: ab 12 €', es:'Preis: ab 12 €', it:'Preis: ab 12 €' },
  'kat.deko.item2.long': { de:'Miniaturen, Deko-Objekte, Vasen und Skulpturen. Resin für maximale Details oder FDM für größere Stücke.', en:'Miniaturen, Deko-Objekte, Vasen und Skulpturen. Resin für maximale Details oder FDM für größere Stücke.', fr:'Miniaturen, Deko-Objekte, Vasen und Skulpturen. Resin für maximale Details oder FDM für größere Stücke.', es:'Miniaturen, Deko-Objekte, Vasen und Skulpturen. Resin für maximale Details oder FDM für größere Stücke.', it:'Miniaturen, Deko-Objekte, Vasen und Skulpturen. Resin für maximale Details oder FDM für größere Stücke.' },
  'kat.deko.item2.spec1': { de:'FDM oder Resin', en:'FDM oder Resin', fr:'FDM oder Resin', es:'FDM oder Resin', it:'FDM oder Resin' },
  'kat.deko.item2.spec2': { de:'Bis 325mm Höhe', en:'Bis 325mm Höhe', fr:'Bis 325mm Höhe', es:'Bis 325mm Höhe', it:'Bis 325mm Höhe' },
  'kat.deko.item2.spec3': { de:'Preis: ab 8 €', en:'Preis: ab 8 €', fr:'Preis: ab 8 €', es:'Preis: ab 8 €', it:'Preis: ab 8 €' },
  'kat.deko.item3.long': { de:'Schlüsselanhänger, Untersetzer, Boxen, Handyhüllen — mit Namen, Datum oder eigenem Design.', en:'Schlüsselanhänger, Untersetzer, Boxen, Handyhüllen — mit Namen, Datum oder eigenem Design.', fr:'Schlüsselanhänger, Untersetzer, Boxen, Handyhüllen — mit Namen, Datum oder eigenem Design.', es:'Schlüsselanhänger, Untersetzer, Boxen, Handyhüllen — mit Namen, Datum oder eigenem Design.', it:'Schlüsselanhänger, Untersetzer, Boxen, Handyhüllen — mit Namen, Datum oder eigenem Design.' },
  'kat.deko.item3.spec1': { de:'3D-Druck + Lasergravur', en:'3D-Druck + Lasergravur', fr:'3D-Druck + Lasergravur', es:'3D-Druck + Lasergravur', it:'3D-Druck + Lasergravur' },
  'kat.deko.item3.spec2': { de:'Einzelstücke oder Sets', en:'Einzelstücke oder Sets', fr:'Einzelstücke oder Sets', es:'Einzelstücke oder Sets', it:'Einzelstücke oder Sets' },
  'kat.deko.item3.spec3': { de:'Preis: ab 6 €', en:'Preis: ab 6 €', fr:'Preis: ab 6 €', es:'Preis: ab 6 €', it:'Preis: ab 6 €' },
  'kat.deko.item4': { de:'Lampen & Lichtspiele', en:'Lampen & Lichtspiele', fr:'Lampen & Lichtspiele', es:'Lampen & Lichtspiele', it:'Lampen & Lichtspiele' },
  'kat.deko.item4.long': { de:'Lithophane, Lampenschirme und LED-Halter — dein Foto als 3D-gedrucktes Lichtkunstwerk.', en:'Lithophane, Lampenschirme und LED-Halter — dein Foto als 3D-gedrucktes Lichtkunstwerk.', fr:'Lithophane, Lampenschirme und LED-Halter — dein Foto als 3D-gedrucktes Lichtkunstwerk.', es:'Lithophane, Lampenschirme und LED-Halter — dein Foto als 3D-gedrucktes Lichtkunstwerk.', it:'Lithophane, Lampenschirme und LED-Halter — dein Foto als 3D-gedrucktes Lichtkunstwerk.' },
  'kat.deko.item4.spec1': { de:'Material: weißes PLA', en:'Material: weißes PLA', fr:'Material: weißes PLA', es:'Material: weißes PLA', it:'Material: weißes PLA' },
  'kat.deko.item4.spec2': { de:'LED nicht enthalten', en:'LED nicht enthalten', fr:'LED nicht enthalten', es:'LED nicht enthalten', it:'LED nicht enthalten' },
  'kat.deko.item4.spec3': { de:'Preis: ab 15 €', en:'Preis: ab 15 €', fr:'Preis: ab 15 €', es:'Preis: ab 15 €', it:'Preis: ab 15 €' },
  'kat.deko.item5': { de:'Weihnachts- & Saisonales', en:'Weihnachts- & Saisonales', fr:'Weihnachts- & Saisonales', es:'Weihnachts- & Saisonales', it:'Weihnachts- & Saisonales' },
  'kat.deko.item5.long': { de:'Christbaumschmuck, Osterdeko, Halloween-Figuren — saisonal wechselnde Designs.', en:'Christbaumschmuck, Osterdeko, Halloween-Figuren — saisonal wechselnde Designs.', fr:'Christbaumschmuck, Osterdeko, Halloween-Figuren — saisonal wechselnde Designs.', es:'Christbaumschmuck, Osterdeko, Halloween-Figuren — saisonal wechselnde Designs.', it:'Christbaumschmuck, Osterdeko, Halloween-Figuren — saisonal wechselnde Designs.' },
  'kat.deko.item5.spec1': { de:'Multi-Color möglich', en:'Multi-Color möglich', fr:'Multi-Color möglich', es:'Multi-Color möglich', it:'Multi-Color möglich' },
  'kat.deko.item5.spec2': { de:'Auch als Serie', en:'Auch als Serie', fr:'Auch als Serie', es:'Auch als Serie', it:'Auch als Serie' },
  'kat.deko.item5.spec3': { de:'Preis: ab 4 €', en:'Preis: ab 4 €', fr:'Preis: ab 4 €', es:'Preis: ab 4 €', it:'Preis: ab 4 €' },
  'kat.deko.item6': { de:'Acryl-Gravuren', en:'Acryl-Gravuren', fr:'Acryl-Gravuren', es:'Acryl-Gravuren', it:'Acryl-Gravuren' },
  'kat.deko.item6.long': { de:'Transparente Acrylplatten mit Lasergravur — leuchtend mit LED-Sockel. Fotos, Logos, Schriftzüge.', en:'Transparente Acrylplatten mit Lasergravur — leuchtend mit LED-Sockel. Fotos, Logos, Schriftzüge.', fr:'Transparente Acrylplatten mit Lasergravur — leuchtend mit LED-Sockel. Fotos, Logos, Schriftzüge.', es:'Transparente Acrylplatten mit Lasergravur — leuchtend mit LED-Sockel. Fotos, Logos, Schriftzüge.', it:'Transparente Acrylplatten mit Lasergravur — leuchtend mit LED-Sockel. Fotos, Logos, Schriftzüge.' },
  'kat.deko.item6.spec1': { de:'Material: Acryl 3–6mm', en:'Material: Acryl 3–6mm', fr:'Material: Acryl 3–6mm', es:'Material: Acryl 3–6mm', it:'Material: Acryl 3–6mm' },
  'kat.deko.item6.spec2': { de:'LED-Sockel optional', en:'LED-Sockel optional', fr:'LED-Sockel optional', es:'LED-Sockel optional', it:'LED-Sockel optional' },
  'kat.deko.item6.spec3': { de:'Preis: ab 18 €', en:'Preis: ab 18 €', fr:'Preis: ab 18 €', es:'Preis: ab 18 €', it:'Preis: ab 18 €' },
  'kat.funktionsteile.item1': { de:'Zahnräder & Mechanik', en:'Zahnräder & Mechanik', fr:'Zahnräder & Mechanik', es:'Zahnräder & Mechanik', it:'Zahnräder & Mechanik' },
  'kat.funktionsteile.item1.long': { de:'Ersatzteile für Maschinen, Geräte und Haushalt. Verschleißteile wie Zahnräder, Adapter und Halterungen — maßgefertigt aus PLA, PETG oder Nylon.', en:'Ersatzteile für Maschinen, Geräte und Haushalt. Verschleißteile wie Zahnräder, Adapter und Halterungen — maßgefertigt aus PLA, PETG oder Nylon.', fr:'Ersatzteile für Maschinen, Geräte und Haushalt. Verschleißteile wie Zahnräder, Adapter und Halterungen — maßgefertigt aus PLA, PETG oder Nylon.', es:'Ersatzteile für Maschinen, Geräte und Haushalt. Verschleißteile wie Zahnräder, Adapter und Halterungen — maßgefertigt aus PLA, PETG oder Nylon.', it:'Ersatzteile für Maschinen, Geräte und Haushalt. Verschleißteile wie Zahnräder, Adapter und Halterungen — maßgefertigt aus PLA, PETG oder Nylon.' },
  'kat.funktionsteile.item1.spec1': { de:'Materialien: PLA, PETG, PA (Nylon)', en:'Materialien: PLA, PETG, PA (Nylon)', fr:'Materialien: PLA, PETG, PA (Nylon)', es:'Materialien: PLA, PETG, PA (Nylon)', it:'Materialien: PLA, PETG, PA (Nylon)' },
  'kat.funktionsteile.item1.spec2': { de:'Toleranz: ±0.2mm', en:'Toleranz: ±0.2mm', fr:'Toleranz: ±0.2mm', es:'Toleranz: ±0.2mm', it:'Toleranz: ±0.2mm' },
  'kat.funktionsteile.item1.spec3': { de:'Preis: ab 5 €', en:'Preis: ab 5 €', fr:'Preis: ab 5 €', es:'Preis: ab 5 €', it:'Preis: ab 5 €' },
  'kat.funktionsteile.item2': { de:'Gehäuse & Abdeckungen', en:'Gehäuse & Abdeckungen', fr:'Gehäuse & Abdeckungen', es:'Gehäuse & Abdeckungen', it:'Gehäuse & Abdeckungen' },
  'kat.funktionsteile.item2.long': { de:'Individuelle Elektronik-Gehäuse, Schutzabdeckungen und Einhausungen. Passgenau für Arduino, Raspberry Pi, Sensoren und mehr.', en:'Individuelle Elektronik-Gehäuse, Schutzabdeckungen und Einhausungen. Passgenau für Arduino, Raspberry Pi, Sensoren und mehr.', fr:'Individuelle Elektronik-Gehäuse, Schutzabdeckungen und Einhausungen. Passgenau für Arduino, Raspberry Pi, Sensoren und mehr.', es:'Individuelle Elektronik-Gehäuse, Schutzabdeckungen und Einhausungen. Passgenau für Arduino, Raspberry Pi, Sensoren und mehr.', it:'Individuelle Elektronik-Gehäuse, Schutzabdeckungen und Einhausungen. Passgenau für Arduino, Raspberry Pi, Sensoren und mehr.' },
  'kat.funktionsteile.item2.spec1': { de:'Materialien: PETG, ABS, ASA', en:'Materialien: PETG, ABS, ASA', fr:'Materialien: PETG, ABS, ASA', es:'Materialien: PETG, ABS, ASA', it:'Materialien: PETG, ABS, ASA' },
  'kat.funktionsteile.item2.spec2': { de:'Multi-Color möglich', en:'Multi-Color möglich', fr:'Multi-Color möglich', es:'Multi-Color möglich', it:'Multi-Color möglich' },
  'kat.funktionsteile.item2.spec3': { de:'Preis: ab 8 €', en:'Preis: ab 8 €', fr:'Preis: ab 8 €', es:'Preis: ab 8 €', it:'Preis: ab 8 €' },
  'kat.funktionsteile.item3': { de:'Clips & Verbinder', en:'Clips & Verbinder', fr:'Clips & Verbinder', es:'Clips & Verbinder', it:'Clips & Verbinder' },
  'kat.funktionsteile.item3.long': { de:'Kabelclips, Rohrhalter, Schnappverschlüsse und Montage-Adapter. Kleine Teile, große Wirkung.', en:'Kabelclips, Rohrhalter, Schnappverschlüsse und Montage-Adapter. Kleine Teile, große Wirkung.', fr:'Kabelclips, Rohrhalter, Schnappverschlüsse und Montage-Adapter. Kleine Teile, große Wirkung.', es:'Kabelclips, Rohrhalter, Schnappverschlüsse und Montage-Adapter. Kleine Teile, große Wirkung.', it:'Kabelclips, Rohrhalter, Schnappverschlüsse und Montage-Adapter. Kleine Teile, große Wirkung.' },
  'kat.funktionsteile.item3.spec1': { de:'Materialien: PLA, PETG, TPU', en:'Materialien: PLA, PETG, TPU', fr:'Materialien: PLA, PETG, TPU', es:'Materialien: PLA, PETG, TPU', it:'Materialien: PLA, PETG, TPU' },
  'kat.funktionsteile.item3.spec2': { de:'Auch in Kleinserien', en:'Auch in Kleinserien', fr:'Auch in Kleinserien', es:'Auch in Kleinserien', it:'Auch in Kleinserien' },
  'kat.funktionsteile.item3.spec3': { de:'Preis: ab 2 €', en:'Preis: ab 2 €', fr:'Preis: ab 2 €', es:'Preis: ab 2 €', it:'Preis: ab 2 €' },
  'kat.funktionsteile.item4': { de:'Adapter & Übergangsstücke', en:'Adapter & Übergangsstücke', fr:'Adapter & Übergangsstücke', es:'Adapter & Übergangsstücke', it:'Adapter & Übergangsstücke' },
  'kat.funktionsteile.item4.long': { de:'Wenn nichts passt, drucken wir den Adapter. Schlauchverbinder, Gewindeadapter, Reduzierstücke.', en:'Wenn nichts passt, drucken wir den Adapter. Schlauchverbinder, Gewindeadapter, Reduzierstücke.', fr:'Wenn nichts passt, drucken wir den Adapter. Schlauchverbinder, Gewindeadapter, Reduzierstücke.', es:'Wenn nichts passt, drucken wir den Adapter. Schlauchverbinder, Gewindeadapter, Reduzierstücke.', it:'Wenn nichts passt, drucken wir den Adapter. Schlauchverbinder, Gewindeadapter, Reduzierstücke.' },
  'kat.funktionsteile.item4.spec1': { de:'Materialien: PETG, PA, ABS', en:'Materialien: PETG, PA, ABS', fr:'Materialien: PETG, PA, ABS', es:'Materialien: PETG, PA, ABS', it:'Materialien: PETG, PA, ABS' },
  'kat.funktionsteile.item4.spec2': { de:'Nach Maß oder STL', en:'Nach Maß oder STL', fr:'Nach Maß oder STL', es:'Nach Maß oder STL', it:'Nach Maß oder STL' },
  'kat.funktionsteile.item4.spec3': { de:'Preis: ab 5 €', en:'Preis: ab 5 €', fr:'Preis: ab 5 €', es:'Preis: ab 5 €', it:'Preis: ab 5 €' },
  'kat.funktionsteile.item5': { de:'Scharniere & Gelenke', en:'Scharniere & Gelenke', fr:'Scharniere & Gelenke', es:'Scharniere & Gelenke', it:'Scharniere & Gelenke' },
  'kat.funktionsteile.item5.long': { de:'Funktionale Scharniere, Drehgelenke und Klappenmechanismen — auch aus flexiblem TPU.', en:'Funktionale Scharniere, Drehgelenke und Klappenmechanismen — auch aus flexiblem TPU.', fr:'Funktionale Scharniere, Drehgelenke und Klappenmechanismen — auch aus flexiblem TPU.', es:'Funktionale Scharniere, Drehgelenke und Klappenmechanismen — auch aus flexiblem TPU.', it:'Funktionale Scharniere, Drehgelenke und Klappenmechanismen — auch aus flexiblem TPU.' },
  'kat.funktionsteile.item5.spec1': { de:'Materialien: TPU, PA, PETG', en:'Materialien: TPU, PA, PETG', fr:'Materialien: TPU, PA, PETG', es:'Materialien: TPU, PA, PETG', it:'Materialien: TPU, PA, PETG' },
  'kat.funktionsteile.item5.spec2': { de:'Print-in-Place möglich', en:'Print-in-Place möglich', fr:'Print-in-Place möglich', es:'Print-in-Place möglich', it:'Print-in-Place möglich' },
  'kat.funktionsteile.item5.spec3': { de:'Preis: ab 6 €', en:'Preis: ab 6 €', fr:'Preis: ab 6 €', es:'Preis: ab 6 €', it:'Preis: ab 6 €' },
  'kat.funktionsteile.item6': { de:'Dichtungen & Puffer', en:'Dichtungen & Puffer', fr:'Dichtungen & Puffer', es:'Dichtungen & Puffer', it:'Dichtungen & Puffer' },
  'kat.funktionsteile.item6.long': { de:'Flexible Dichtungsringe, Vibrationsdämpfer und Stoßfänger aus TPU.', en:'Flexible Dichtungsringe, Vibrationsdämpfer und Stoßfänger aus TPU.', fr:'Flexible Dichtungsringe, Vibrationsdämpfer und Stoßfänger aus TPU.', es:'Flexible Dichtungsringe, Vibrationsdämpfer und Stoßfänger aus TPU.', it:'Flexible Dichtungsringe, Vibrationsdämpfer und Stoßfänger aus TPU.' },
  'kat.funktionsteile.item6.spec1': { de:'Material: TPU (Shore 95A)', en:'Material: TPU (Shore 95A)', fr:'Material: TPU (Shore 95A)', es:'Material: TPU (Shore 95A)', it:'Material: TPU (Shore 95A)' },
  'kat.funktionsteile.item6.spec2': { de:'Wasserfest', en:'Wasserfest', fr:'Wasserfest', es:'Wasserfest', it:'Wasserfest' },
  'kat.funktionsteile.item6.spec3': { de:'Preis: ab 4 €', en:'Preis: ab 4 €', fr:'Preis: ab 4 €', es:'Preis: ab 4 €', it:'Preis: ab 4 €' },
  'kat.maker.item1.long': { de:'Sensor-Mounts, Kamera-Halter, Kabelmanagement und Wandbefestigungen für Zigbee, Shelly, Aqara & Co.', en:'Sensor-Mounts, Kamera-Halter, Kabelmanagement und Wandbefestigungen für Zigbee, Shelly, Aqara & Co.', fr:'Sensor-Mounts, Kamera-Halter, Kabelmanagement und Wandbefestigungen für Zigbee, Shelly, Aqara & Co.', es:'Sensor-Mounts, Kamera-Halter, Kabelmanagement und Wandbefestigungen für Zigbee, Shelly, Aqara & Co.', it:'Sensor-Mounts, Kamera-Halter, Kabelmanagement und Wandbefestigungen für Zigbee, Shelly, Aqara & Co.' },
  'kat.maker.item1.spec1': { de:'Material: PLA, PETG', en:'Material: PLA, PETG', fr:'Material: PLA, PETG', es:'Material: PLA, PETG', it:'Material: PLA, PETG' },
  'kat.maker.item1.spec2': { de:'Schraublos oder mit Schrauben', en:'Schraublos oder mit Schrauben', fr:'Schraublos oder mit Schrauben', es:'Schraublos oder mit Schrauben', it:'Schraublos oder mit Schrauben' },
  'kat.maker.item1.spec3': { de:'Preis: ab 3 €', en:'Preis: ab 3 €', fr:'Preis: ab 3 €', es:'Preis: ab 3 €', it:'Preis: ab 3 €' },
  'kat.maker.item2.long': { de:'Tool-Holder, Bit-Halter, Sortierboxen und Wandsysteme. Schluss mit Chaos in der Werkstatt.', en:'Tool-Holder, Bit-Halter, Sortierboxen und Wandsysteme. Schluss mit Chaos in der Werkstatt.', fr:'Tool-Holder, Bit-Halter, Sortierboxen und Wandsysteme. Schluss mit Chaos in der Werkstatt.', es:'Tool-Holder, Bit-Halter, Sortierboxen und Wandsysteme. Schluss mit Chaos in der Werkstatt.', it:'Tool-Holder, Bit-Halter, Sortierboxen und Wandsysteme. Schluss mit Chaos in der Werkstatt.' },
  'kat.maker.item2.spec1': { de:'Material: PLA, PETG', en:'Material: PLA, PETG', fr:'Material: PLA, PETG', es:'Material: PLA, PETG', it:'Material: PLA, PETG' },
  'kat.maker.item2.spec2': { de:'Modular erweiterbar', en:'Modular erweiterbar', fr:'Modular erweiterbar', es:'Modular erweiterbar', it:'Modular erweiterbar' },
  'kat.maker.item2.spec3': { de:'Preis: ab 5 €', en:'Preis: ab 5 €', fr:'Preis: ab 5 €', es:'Preis: ab 5 €', it:'Preis: ab 5 €' },
  'kat.maker.item3.long': { de:'Architekturmodelle, Gelände für Tabletop, Fahrzeugteile und Schiffsmodelle. FDM oder Resin je nach Detail.', en:'Architekturmodelle, Gelände für Tabletop, Fahrzeugteile und Schiffsmodelle. FDM oder Resin je nach Detail.', fr:'Architekturmodelle, Gelände für Tabletop, Fahrzeugteile und Schiffsmodelle. FDM oder Resin je nach Detail.', es:'Architekturmodelle, Gelände für Tabletop, Fahrzeugteile und Schiffsmodelle. FDM oder Resin je nach Detail.', it:'Architekturmodelle, Gelände für Tabletop, Fahrzeugteile und Schiffsmodelle. FDM oder Resin je nach Detail.' },
  'kat.maker.item3.spec1': { de:'FDM oder Resin', en:'FDM oder Resin', fr:'FDM oder Resin', es:'FDM oder Resin', it:'FDM oder Resin' },
  'kat.maker.item3.spec2': { de:'Maßstab nach Wunsch', en:'Maßstab nach Wunsch', fr:'Maßstab nach Wunsch', es:'Maßstab nach Wunsch', it:'Maßstab nach Wunsch' },
  'kat.maker.item3.spec3': { de:'Preis: ab 8 €', en:'Preis: ab 8 €', fr:'Preis: ab 8 €', es:'Preis: ab 8 €', it:'Preis: ab 8 €' },
  'kat.maker.item4': { de:'Raspberry Pi & Arduino Zubehör', en:'Raspberry Pi & Arduino Zubehör', fr:'Raspberry Pi & Arduino Zubehör', es:'Raspberry Pi & Arduino Zubehör', it:'Raspberry Pi & Arduino Zubehör' },
  'kat.maker.item4.long': { de:'Gehäuse, Halterungen, Einbaurahmen und Abstandshalter für Einplatinencomputer und Mikrocontroller.', en:'Gehäuse, Halterungen, Einbaurahmen und Abstandshalter für Einplatinencomputer und Mikrocontroller.', fr:'Gehäuse, Halterungen, Einbaurahmen und Abstandshalter für Einplatinencomputer und Mikrocontroller.', es:'Gehäuse, Halterungen, Einbaurahmen und Abstandshalter für Einplatinencomputer und Mikrocontroller.', it:'Gehäuse, Halterungen, Einbaurahmen und Abstandshalter für Einplatinencomputer und Mikrocontroller.' },
  'kat.maker.item4.spec1': { de:'Material: PETG, ABS', en:'Material: PETG, ABS', fr:'Material: PETG, ABS', es:'Material: PETG, ABS', it:'Material: PETG, ABS' },
  'kat.maker.item4.spec2': { de:'Passgenau', en:'Passgenau', fr:'Passgenau', es:'Passgenau', it:'Passgenau' },
  'kat.maker.item4.spec3': { de:'Preis: ab 4 €', en:'Preis: ab 4 €', fr:'Preis: ab 4 €', es:'Preis: ab 4 €', it:'Preis: ab 4 €' },
  'kat.maker.item5': { de:'Drohnen-Teile', en:'Drohnen-Teile', fr:'Drohnen-Teile', es:'Drohnen-Teile', it:'Drohnen-Teile' },
  'kat.maker.item5.long': { de:'Propeller-Guards, Kamerahalter, Landegestelle und GoPro-Mounts. Leicht und stabil.', en:'Propeller-Guards, Kamerahalter, Landegestelle und GoPro-Mounts. Leicht und stabil.', fr:'Propeller-Guards, Kamerahalter, Landegestelle und GoPro-Mounts. Leicht und stabil.', es:'Propeller-Guards, Kamerahalter, Landegestelle und GoPro-Mounts. Leicht und stabil.', it:'Propeller-Guards, Kamerahalter, Landegestelle und GoPro-Mounts. Leicht und stabil.' },
  'kat.maker.item5.spec1': { de:'Material: PLA-CF, PETG', en:'Material: PLA-CF, PETG', fr:'Material: PLA-CF, PETG', es:'Material: PLA-CF, PETG', it:'Material: PLA-CF, PETG' },
  'kat.maker.item5.spec2': { de:'Leichtbau-optimiert', en:'Leichtbau-optimiert', fr:'Leichtbau-optimiert', es:'Leichtbau-optimiert', it:'Leichtbau-optimiert' },
  'kat.maker.item5.spec3': { de:'Preis: ab 6 €', en:'Preis: ab 6 €', fr:'Preis: ab 6 €', es:'Preis: ab 6 €', it:'Preis: ab 6 €' },
  'kat.maker.item6': { de:'Retro & Gaming', en:'Retro & Gaming', fr:'Retro & Gaming', es:'Retro & Gaming', it:'Retro & Gaming' },
  'kat.maker.item6.long': { de:'Controller-Halter, Cartridge-Ständer, Gehäuse für Retro-Pi, Arcade-Buttons und Joystick-Mounts.', en:'Controller-Halter, Cartridge-Ständer, Gehäuse für Retro-Pi, Arcade-Buttons und Joystick-Mounts.', fr:'Controller-Halter, Cartridge-Ständer, Gehäuse für Retro-Pi, Arcade-Buttons und Joystick-Mounts.', es:'Controller-Halter, Cartridge-Ständer, Gehäuse für Retro-Pi, Arcade-Buttons und Joystick-Mounts.', it:'Controller-Halter, Cartridge-Ständer, Gehäuse für Retro-Pi, Arcade-Buttons und Joystick-Mounts.' },
  'kat.maker.item6.spec1': { de:'Multi-Color möglich', en:'Multi-Color möglich', fr:'Multi-Color möglich', es:'Multi-Color möglich', it:'Multi-Color möglich' },
  'kat.maker.item6.spec2': { de:'Auch mit Gravur', en:'Auch mit Gravur', fr:'Auch mit Gravur', es:'Auch mit Gravur', it:'Auch mit Gravur' },
  'kat.maker.item6.spec3': { de:'Preis: ab 5 €', en:'Preis: ab 5 €', fr:'Preis: ab 5 €', es:'Preis: ab 5 €', it:'Preis: ab 5 €' },
