...
const TRANSLATIONS = {
  ...
  'values.possibilities.text':    { de:'FDM, Resin, Laser — von der Miniatur bis zum Gehäuse. Wenn du es dir vorstellen kannst, können wir es bauen.', en:'FDM, Resin, Laser — from miniature to housing. If you can imagine it, we can build it.', fr:'FDM, Resin, Laser — de la miniature au boîtier. Si vous pouvez l\'imaginer, nous pouvons le construire.', es:'FDM, Resin, Laser — desde la miniatura hasta la carcasa. Si puedes imaginarlo, podemos construirlo.', it:'FDM, Resin, Laser — dalla miniatura all\'alloggiamento. Se riesci a immaginarlo, possiamo costruirlo.' },
